...
public class TodayMealAdapter extends RecyclerView.Adapter<TodayMealAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // In a real app, we would load image here if item.imageUrl is present
        // Glide.with(holder.itemView).load(item.imageUrl).placeholder(R.drawable.ic_nav_diary).into(holder.imgMeal);
    }
